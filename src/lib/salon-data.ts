...
export const services: Service[] = [
  { id: "women-cut", category: "Haircuts", name: "Women's Haircut", description: "A tailored cut with consultation, wash, finish and styling advice.", duration: 60, price: 55, image: "https://elearning.uwezocollege.ac.ke/cmis/uploads/icons/GHD1.png?v=a82429055717566599b0cfd926c31d35", active: true },
  { id: "men-cut", category: "Haircuts", name: "Men's Haircut", description: "Precision cutting, clean finish and styling for everyday shape.", duration: 40, price: 38, image: "https://www.gosupps.com/media/catalog/product/cache/25/image/1500x/040ec09b1e35df139433887a97daa66f/7/1/717EM2Ai2XL._SL1500_.jpg", active: true },
  { id: "kids-cut", category: "Haircuts", name: "Kids Haircut", description: "Gentle, practical haircut for children up to 12 years old.", duration: 30, price: 28, image: "https://www.findin.am/wp-content/uploads/2023/03/VaVa-Kids-Hair-Salon-Findin-3.jpg", active: true },
  { id: "full-color", category: "Color", name: "Full Color", description: "Rich all-over colour with professional tone selection and gloss finish.", duration: 120, price: 95, image: "https://snssalonshooteducation.com/img/Category/13ffecd3-ddc0-483b-82f4-3c15ea895615.jpg", active: true },
  { id: "root-color", category: "Color", name: "Root Color", description: "Seamless root refresh matched to your existing colour.", duration: 90, price: 68, image: "https://www.beautifulbabesimagestudio.com/hs-fs/hubfs/AI-Generated%20Media/Images/root%20touch%20up%20application%20at%20hair%20salon%20beautiful%20picture-1.png?height=1024&name=root+touch+up+application+at+hair+salon+beautiful+picture-1.png&width=1024", active: true },
  { id: "highlights", category: "Color", name: "Highlights", description: "Soft, dimensional brightness placed to flatter your haircut and skin tone.", duration: 150, price: 115, image: "https://olvirsalon.in/assets/images/services/Hair-colour.jpg", active: true },
  { id: "balayage", category: "Color", name: "Balayage", description: "Natural, dimensional highlights customized to your hair and personal style.", duration: 150, price: 120, image: "https://cdn.shopify.com/s/files/1/0630/6372/0173/files/balayage_hair_technique.webp?v=1775623870", active: true },
  { id: "blow-dry", category: "Styling", name: "Blow Dry", description: "Polished blow dry with movement, volume and long-lasting finish.", duration: 40, price: 42, image: "https://static.wixstatic.com/media/7d046e_9dd56e30739245ce90e039d4d1f8bcfe~mv2.webp/v1/fill/w_1470%2Ch_980%2Cal_c%2Cq_85%2Cusm_0.66_1.00_0.01%2Cenc_avif%2Cquality_auto/7d046e_9dd56e30739245ce90e039d4d1f8bcfe~mv2.webp", active: true },
  { id: "hair-styling", category: "Styling", name: "Hair Styling", description: "Elegant styling for dinner, events, photoshoots or a refined daily look.", duration: 55, price: 62, image: "https://static.wixstatic.com/media/016864_82a96c8a26d847bd83572cd461b1b3bb~mv2.png/v1/fill/w_1024%2Ch_1536%2Cal_c%2Cq_90%2Cenc_auto/016864_82a96c8a26d847bd83572cd461b1b3bb~mv2.png", active: true },
  { id: "wedding-styling", category: "Styling", name: "Wedding Styling", description: "Trial and event styling with notes saved for the wedding day.", duration: 90, price: 110, image: "https://cdn0.hitched.co.uk/vendor/9685/3_2/960/jpg/img-8784_4_179685-1569958439.jpeg", active: true },
  { id: "repair-treatment", category: "Treatments", name: "Hair Repair Treatment", description: "Deep repair ritual for dry, fragile or colour-treated hair.", duration: 45, price: 52, image: "https://cdn.webshopapp.com/shops/72615/files/447871281/image.jpg", active: true },
  { id: "keratin", category: "Treatments", name: "Keratin Treatment", description: "Smoothing treatment for controlled shine and easier styling.", duration: 120, price: 145, image: "https://rhairandbeauty.com.au/wp-content/uploads/2025/11/Keratin-image.png", active: true },
  { id: "scalp", category: "Treatments", name: "Scalp Treatment", description: "Clarifying scalp care with massage and personalised home-care advice.", duration: 45, price: 48, image: "https://www.welefulunisexsalon.com/images/services/head-massage-for-hair-and-scalp-health1.png", active: true },
  { id: "beard-trim", category: "Grooming", name: "Beard Trim", description: "Clean shaping and finishing for a refined beard line.", duration: 25, price: 24, image: "https://m.media-amazon.com/images/I/91CBk39EkmS._SL1500_.jpg", active: true },
];

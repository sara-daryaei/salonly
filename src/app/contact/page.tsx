  ...
  return (
    <PublicPage>
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 font-serif text-6xl">Visit us on Avenue Louise.</h1>
      </section>
      <section className="mx-auto grid max-w-7xl gap-8 px-4 pb-24 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
        ...
        <form className="rounded-[2rem] border border-[#34251c]/10 bg-[#fffaf4] p-7">
          <h2 className="font-serif text-3xl">Send Message</h2>
          <div className="mt-6 grid gap-4">
            {["Name", "Email", "Phone"].map((field) => <input key={field} className="rounded-2xl border border-[#34251c]/10 bg-white px-4 py-3 outline-none focus:border-[#9a7a58]" placeholder={field} />)}
            <textarea className="min-h-40 rounded-2xl border border-[#34251c]/10 bg-white px-4 py-3 outline-none focus:border-[#9a7a58]" placeholder="Message" />
            <button className="rounded-full bg-[#2f2118] px-5 py-4 font-semibold text-white">Send Message</button>
          </div>
